// No need to import layout components as we're using the MainLayout wrapper in App.tsx
...
export default function HelpCenterPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-heading">Help Center</h1>
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div className="flex items-center mb-4">
                ...
                <a href="mailto:info@myweddingdream.co" className="text-primary hover:underline">
